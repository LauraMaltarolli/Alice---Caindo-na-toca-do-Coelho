...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.sprite_normal = pygame.transform.smoothscale(
            alice_raw, self._scale_keep_ratio(alice_raw, self.size_normal)
        )
        self.sprite_small = pygame.transform.smoothscale(
            alice_raw, self._scale_keep_ratio(alice_raw, self.size_small)
        )
        self.sprite_big = pygame.transform.smoothscale(
            alice_raw, self._scale_keep_ratio(alice_raw, self.size_big)
        )
